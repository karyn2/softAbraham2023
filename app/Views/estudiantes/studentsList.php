                        ...
                        <div class="mt-4 table-container" >
                            ...
                            id="miTabla" name="miTabla" style="width:100%">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="#" type="button" class="btn btn-info btn-sm edit-btn" title="Editar" data-id_usuario="<?php echo $estudiante['id_usuario']; ?>">
                                            <i id="pencil-icon" class="fas fa-pencil-alt" aria-hidden="true"></i>
                                        </a>
                                        <a href="#" type="button" class="btn btn-warning btn-sm view-btn" title="Ver" data-id_usuario="<?php echo $estudiante['id_usuario']; ?>">
            ...
            <form action="<?php echo base_url()?>ActualizarEstudiante" method="POST" id="formEditarEst">
                ...
                <div class="modal-body">
                    ...
                    <div class="row mt-2">
                        ...
                        <div class="col-md-6">
                            <label for="fechaReg" class="form-label"><b class="requerido">*&nbsp;</b>Fecha de Registro:</label>
                    ...
                    <div class="row mt-2">
                        <div class="col-md-6">
                            <label for="fechaNac" class="form-label"><b class="requerido">*&nbsp;</b>Fecha de Nacimiento:</label>
                    ...
                    <div class="row mt-2">
                        <div class="col-md-6">
                            <label for="curso" class="form-label"><b class="requerido">*&nbsp;</b>Curso Matriculado:</label>
                            <select id="curso" name="curso" class="form-select">
                                 <option value="">Seleccionar Curso</option>
                            </select>
                        </div>
                        <div class="col-md-6">
                            <label for="docAcudiente" class="form-label"><b class="requerido">*&nbsp;</b> N°  de Documento del acudiente</label>
                            <input type="text" class="form-control" id="docAcudiente" name="docAcudiente" >
                        </div>            
                    </div>
                    <div class="row mt-2">
                        <div class="col-md-6">
                            <label for="nomAcudiente" class="form-label"><b class="requerido">*&nbsp;</b>Nombre acudiente:</label>
                            <input type="text" class="form-control" id="nomAcudiente" name="nomAcudiente">
                        </div>
                        <div class="col-md-6">
                            <label for="telAcudiente" class="form-label"><b class="requerido">*&nbsp;</b>Teléfono acudiente</label>
                ...
                <div class="modal-footer">
                    ...
                    <button   class="botonRegistrar" onclick=EditarEstudiante()
                     type="button"  >
