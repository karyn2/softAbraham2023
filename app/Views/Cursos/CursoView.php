...
<div class="container mt-4" >
    ...
    <div class="row ">
      <div class="col-md-6 mt-2 sombra">
        <a href="<?php echo base_url('Asignaturas');?>" class="menu-option bordeRedondo text-decoration-none "
      ...
      <div class="col-md-6 mt-2">
        <a href="<?php echo base_url('cursos')?>" class="menu-option bordeRedondo text-decoration-none" style="background-color: #5EBF16;">
